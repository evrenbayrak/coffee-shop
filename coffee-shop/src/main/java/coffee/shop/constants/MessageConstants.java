package coffee.shop.constants;

public class MessageConstants {

	public static final String COFFEE_ORDER_MESSAGE = "Teşekkürler kahveniz hazırlanıyor.";
	public static final String DEFAULT_ORDER_MESSAGE = "Teşekkürler siparişiniz hazırlanıyor.";
